...
export type SectionBlocksItem = BlogPost | Column | Customer | Event | CallToAction | ListBlock | MarkdownBody | MediaBlock | PartnersCard | Person | PricingPlan | PricingPlanV2 | Quote2 | SectionBlock | Tweet | Form;
